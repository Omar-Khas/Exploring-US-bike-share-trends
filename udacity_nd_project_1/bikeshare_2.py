...
def load_data(city, month, day):
    ...
    """
    # This part is the same as the practice problem 3 in last section
...
def station_stats(df):
    ...
    comb = pd.DataFrame(df.value_counts(['Start Station', 'End Station']))
    print("Most common Combination of Stations: ", comb[0:1])
